...
import application.wan.bdd.verifier.apkeep.checker.CheckerNAT;
...
public class DPVerifierNAT {
    ...
    public DPVerifierNAT(String network_name, ArrayList<String> topo, ArrayList<String> edge_ports,
            ...
            ArrayList<String> NAT_rules)
            throws IOException {
        apkeepNetworkModel = new Network_NAT(network_name);
        apkeepNetworkModel.initializeNetwork(topo, edge_ports, dpDevices, NAT_rules);
    }

    public void run(ArrayList<String> forwarding_rules, ArrayList<String> acl_rules, ArrayList<String> NAT_rules)
            throws IOException {
    ...
    public void DotInBatch(HashSet<Integer> aps, String middleStr) {
        ...
        for (int ap : aps) {
            ...
            apkeepNetworkModel.bdd_engine.getBDD().printDot(
                    "/home/zcli/lzc/Field-Decision-Network/apkatra-main/output/test/" + middleStr + "_" + count, ap);
        }
    }
}
