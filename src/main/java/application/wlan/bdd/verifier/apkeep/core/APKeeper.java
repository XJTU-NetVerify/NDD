...
import application.wlan.bdd.verifier.apkeep.checker.Property;
...
import application.wlan.bdd.verifier.apkeep.utils.Parameters;
...
public class APKeeper {
	...
	// public void TryMergeAPBatchNAT(HashMap<String, HashSet<Integer>> moved_batch_aps) {
	// 	if (!MergeAP)
	// 		return;
	// 	if (ports_to_merge.isEmpty())
	// 		return;
