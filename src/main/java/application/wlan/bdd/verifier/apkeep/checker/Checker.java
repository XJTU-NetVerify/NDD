...
public class Checker {
    ...
    public void OutputReachBDD() throws IOException
    {
        for(PositionTuple src : reach.keySet())
        {
            ...
            {
                BDDIO.save(net.bdd_engine.getBDD(), reach.get(src).get(dst), "/home/zcli/lzc/Field-Decision-Network/apkatra-main/output/single/"+net.name+"/correctness/APKeep/"+src.getDeviceName()+"_"+dst.getDeviceName());
            }
        }
    }
