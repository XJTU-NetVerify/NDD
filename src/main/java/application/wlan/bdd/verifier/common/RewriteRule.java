package application.wlan.bdd.verifier.common;
...
public class RewriteRule{
	...
	public RewriteRule(long old_src_prefix, int old_src_len, long old_dst_prefix, int old_dst_len, long new_src_prefix, int new_src_len, long new_dst_prefix, int new_dst_len,  String rname, int p, BDDACLWrapper baw)
	{
        int old_src;
        if(old_src_len==0)
        {
