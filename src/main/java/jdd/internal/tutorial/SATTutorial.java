...
public class SATTutorial extends TutorialHelper{
	public SATTutorial() {
		...
		showClass("jndd.sat.Lit");
		showClass("jndd.sat.Var");
		showClass("jndd.sat.Clause");
		showClass("jndd.sat.CNF");


		h3("Basic SAT solvers");

		JDDConsole.out.println("The class <tt>Solver</tt> is the base class for all CNF solvers:");
		showClass("jndd.sat.Solver");
		JDDConsole.out.println("A solution is returned as a experiment.vector of integers (int []), where an value of " +
		...
		showClass("jndd.sat.bdd.BDDSolver");
		...
		showClass("jndd.sat.gsat.GSATSolver");
		showClass("jndd.sat.gsat.GSAT2Solver");

		JDDConsole.out.println("<p>These two performs so bad, they are not worth using anywhere...");
		showClass("jndd.sat.gsat.WalkSATSolver");
		showClass("jndd.sat.gsat.WalkSATSKCSolver");
		...
		showClass("jndd.sat.dpll.DPLLSolver");
		...
		showClass("jndd.sat.DimacsReader");
